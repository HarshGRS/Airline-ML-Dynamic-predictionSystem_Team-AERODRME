    ...
    <div style={{ maxWidth: '800px', margin: '4rem auto', padding: '0 2rem' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', color: 'var(--text-main)', lineHeight: 1.7 }}>
        <section>
          ...
          <p>
            When you use AERODROME, we may collect information about your searches, route preferences, and interactions with our predictions. If you create an account, we store your profile information (like email and name provided via Google OAuth) and any routes you save to your Saved Searches.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Your search history and saved routes are used strictly to provide you with personalized fare predictions and saved search alerts. We do not sell your personal data to third parties. Anonymised search trends may be used to improve our XGBoost machine learning model's accuracy.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We use secure cookies to maintain your session (via JWT) and store your saved searches. These are essential for the platform's core functionality.
          </p>
        </section>
